...
:help
echo simRaid1 by aaviator42
echo v1.0   [2020-01-04]
echo https://github.com/aaviator42/simRaid1
echo:
echo Usage:
...
echo but it's close enough for most use cases.
echo:
...
echo:
echo Please visit the Github repo for more information.
echo:
